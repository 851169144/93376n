...
#??״ͼ
pdf(file="barplot.pdf", width=10, height=14)
...
#????ͼ
pdf(file="bubble.pdf", width=10, height=14)
...
write.table(data, file="GOdata.txt", sep="\t", quote=F, row.names = F)
#????Ȧͼ????
